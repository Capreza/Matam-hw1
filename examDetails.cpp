...
namespace mtm
{
    ...
    std::ostream& operator<<(std::ostream& os, const ExamDetails& exam) 
    {
        ...
        return os <<"Course Number: "<<exam.course_num<< std::endl<<"Time: "<<exam.exam_day<<"."<<exam.exam_month<<" at "<<
        exam_time_round_hour<<":"<<exam_time_half_hour_to_print<<"0"<<std::endl
        <<"Duration: "<<exam.exam_len<<":00"<<std::endl<<"Zoom Link: "<<exam.zoom_link<<std::endl;
    }
