...
void GroupManager::RemovePlayer(int PlayerId)
{
    ...
    if (*curr_group_ptr->PlayerTree.HighestLevelInGroup == *player_for_level_ptr)
    {
        curr_group_ptr->PlayerTree.HighestLevelInGroup = curr_group_ptr->PlayerTree.getMaxNodeData();
    }
    if (*NonEmptyGroupsTree.HighestLevelOverall == *player_for_level_ptr)
    {
...
void GroupManager::IncreaseLevel(int PlayerId, int LevelIncrease)
{
    ...
    player_for_level_ptr->Level += LevelIncrease;
    ...
    if (*NonEmptyGroupsTree.HighestLevelOverall < *player_for_level_ptr)
    {
        NonEmptyGroupsTree.HighestLevelOverall = player_for_level_ptr;
    }
    if (*temp_group_ptr->PlayerTree.HighestLevelInGroup < *player_for_level_ptr)
    {
        temp_group_ptr->PlayerTree.HighestLevelInGroup = player_for_level_ptr;
    }
}
